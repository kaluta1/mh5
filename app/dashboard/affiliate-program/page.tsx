            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-bold text-myhigh5-primary">5%</p>
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
                  Maximum potential commission: <span className="font-semibold text-gray-900 dark:text-white">38%</span> (5% + 2% × 9 levels)
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  Earn commissions on paid club membership fees. The website charges 5% of membership fees, and you earn a share of that.
                </p>
                <p className="text-lg font-bold text-myhigh5-primary">
                  5% on Level 1, 2% on Levels 2-10
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  Earn commissions on digital content purchases in the MyHigh5 shop. The website charges 5% platform fees, and you earn a share of that.
                </p>
                <p className="text-lg font-bold text-myhigh5-primary">
                  5% on Level 1, 2% on Levels 2-10
                </p>
