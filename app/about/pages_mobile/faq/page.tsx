  ...
  const waysToEarn = [
    {
      ...
      commission: t('landing.ways_to_earn.kyc_payments.commission') || '5% au niveau 1, 2% aux niveaux 2-10'
    },
    {
      icon: Award,
      ...
      commission: t('landing.ways_to_earn.founding_membership.commission') || '5% au niveau 1, 2% aux niveaux 2-10'
    },
    {
      icon: Users,
      ...
      commission: t('landing.ways_to_earn.club_memberships.commission') || '5% au niveau 1, 2% aux niveaux 2-10'
    },
    {
      icon: Store,
      ...
      commission: t('landing.ways_to_earn.shop_purchases.commission') || '5% au niveau 1, 2% aux niveaux 2-10'
    },
    {
      icon: TrendingUp,
      ...
      commission: t('landing.ways_to_earn.ad_revenue.commission') || '5% au niveau 1, 1% aux niveaux 2-10'
    },
    {
      icon: Sparkles,
      title: t('landing.ways_to_earn.ad_campaigns.title') || 'Page Sponsors du Site',
      description: t('landing.ways_to_earn.ad_campaigns.description') || 'Les sponsors de niveau 1 gagnent une commission de 5%, et les niveaux 2 à 10 gagnent 1% chacun.',
      commission: t('landing.ways_to_earn.ad_campaigns.commission') || '5% au niveau 1, 1% aux niveaux 2-10'
    }
  ]
