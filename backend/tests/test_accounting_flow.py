...
def test_membership_payment_accounting_flow(db: Session):
    ...
    db.add(user) # Note: user gets ID after flush/commit inside session used mostly
    db.commit()
...
def test_membership_payment_accounting_flow(db: Session):
    ...
    # Validate
    # PATCH: Add missing attributes to user object to prevent crash in service
    ...
    # Commission sponsor should be 5.0 (10% of 50)
