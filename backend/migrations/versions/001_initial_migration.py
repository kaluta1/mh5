...
def upgrade():
    ...
    # Existing DB may already contain base tables while alembic_version is empty.
    # Skip 001 in that case to avoid DuplicateTable on bootstrap tables.
    if {"wallet", "contest", "location", "media"} & existing_tables:
        return
