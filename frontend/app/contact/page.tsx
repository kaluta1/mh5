...
export default function ContactPage() {
  ...
  const faqData: Record<string, { question: string; answer: string }[]> = {
    ...
    es: [
      ...
      { question: "¿Cómo funciona el programa de afiliados?", answer: "Para los pagos de tarifas de verificación, ganas una comisión del 10% sobre los pagos realizados por tus referidos directos, y una comisión del 1% sobre los pagos realizados por cada uno de tus referidos indirectos del Nivel 2 al Nivel 10. Para los ingresos publicitarios, los concursantes participantes reciben el 20% de los ingresos publicitarios generados en sus páginas de concurso. El patrocinador directo de un concursante participante recibe el 5%, y cada patrocinador indirecto del Nivel 2 al Nivel 10 recibe el 0.5%. Los miembros que nominan reciben el 5% de los ingresos publicitarios generados en las páginas de concurso de sus concursantes nominados, el 2.5% de los ingresos publicitarios generados en las páginas de concurso de concursantes nominados por sus referidos directos, y el 0.5% de los ingresos publicitarios generados en las páginas de concurso de concursantes nominados por cada uno de sus referidos indirectos del Nivel 2 al Nivel 10. Para los clubes, los propietarios de clubes reciben el 20% de los ingresos publicitarios generados en sus páginas de club o fan. El patrocinador directo de un propietario de club recibe el 5%, y cada patrocinador indirecto del Nivel 2 al Nivel 10 recibe el 0.5%. Para las tarifas de membresía del club, MyHigh5 aplica un margen del 10% a la tarifa de suscripción seleccionada por el miembro. De este margen, el 10% se paga al patrocinador directo del pagador, y el 1% se paga a cada patrocinador indirecto del Nivel 2 al Nivel 10." }
    ],
    de: [
      ...
      { question: "Wie funktioniert das Partnerprogramm?", answer: "Für Verifizierungsgebührenzahlungen erhalten Sie eine Provision von 10% auf Zahlungen Ihrer direkten Empfehlungen und eine Provision von 1% auf Zahlungen jeder Ihrer indirekten Empfehlungen von Stufe 2 bis Stufe 10. Für Werbeeinnahmen erhalten teilnehmende Teilnehmer 20% der Werbeeinnahmen, die auf ihren Wettbewerbsseiten generiert werden. Der direkte Sponsor eines teilnehmenden Teilnehmers erhält 5%, und jeder indirekte Sponsor von Stufe 2 bis Stufe 10 erhält 0.5%. Nominierende Mitglieder erhalten 5% der Werbeeinnahmen, die auf den Wettbewerbsseiten ihrer nominierten Teilnehmer generiert werden, 2.5% der Werbeeinnahmen, die auf den Wettbewerbsseiten von Teilnehmern generiert werden, die von ihren direkten Empfehlungen nominiert wurden, und 0.5% der Werbeeinnahmen, die auf den Wettbewerbsseiten von Teilnehmern generiert werden, die von jeder ihrer indirekten Empfehlungen von Stufe 2 bis Stufe 10 nominiert wurden. Für Clubs erhalten Clubbesitzer 20% der Werbeeinnahmen, die auf ihren Club- oder Fan-Seiten generiert werden. Der direkte Sponsor eines Clubbesitzers erhält 5%, und jeder indirekte Sponsor von Stufe 2 bis Stufe 10 erhält 0.5%. Für Club-Mitgliedsgebühren wendet MyHigh5 einen Aufschlag von 10% auf die vom Mitglied ausgewählte Abonnementgebühr an. Von diesem Aufschlag werden 10% an den direkten Sponsor des Zahlers gezahlt, und 1% werden an jeden indirekten Sponsor von Stufe 2 bis Stufe 10 gezahlt." }
    ]
  }
