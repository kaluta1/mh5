      ...
      <main className="pt-24 pb-16">
        ...
        <section className="container px-4 md:px-6 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Intro */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 shadow-lg border border-gray-200 dark:border-gray-700 mb-8">
            ...
            <div className="mt-12 bg-gradient-to-r from-myfav-primary to-myfav-secondary rounded-2xl p-8 text-center text-white">
              ...
              <a 
                href="mailto:privacy@myhigh5.com" 
