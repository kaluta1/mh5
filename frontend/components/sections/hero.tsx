  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 pt-20 md:pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-myfav-primary/20 to-myfav-secondary/20 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-4rem)]">
          ...
          <div className="flex flex-col space-y-8 lg:space-y-10 text-center lg:text-left">
            {/* Badge */}
            {/* <div className="inline-flex items-center gap-2 bg-gradient-to-r from-myfav-primary/10 to-myfav-secondary/10 backdrop-blur-sm border border-myfav-primary/20 rounded-full px-4 py-2 w-fit mx-auto lg:mx-0">
              <Sparkles className="w-4 h-4 text-myfav-primary" />
              <span className="text-sm font-semibold text-myfav-primary">
            ...
            <div className="space-y-6 lg:space-y-8">
              <h1 className="text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl font-black tracking-tight leading-[1.1] text-gray-900 dark:text-white">
                ...
                <span className="block bg-gradient-to-r from-myfav-primary via-myfav-secondary to-myfav-primary bg-clip-text text-transparent animate-gradient">
                  {t('hero.title_line2')}
                </span>
            ...
            {/* <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-4">
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-5 sm:p-6 shadow-lg dark:shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-myfav-primary/10 to-myfav-secondary/10 rounded-xl mb-3 sm:mb-4 mx-auto group-hover:scale-110 transition-transform">
                  <Users className="h-6 w-6 sm:h-7 sm:w-7 text-myfav-primary dark:text-myfav-blue-400" />
                </div>
              ...
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-5 sm:p-6 shadow-lg dark:shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-myfav-primary/10 to-myfav-secondary/10 rounded-xl mb-3 sm:mb-4 mx-auto group-hover:scale-110 transition-transform">
                  <Trophy className="h-6 w-6 sm:h-7 sm:w-7 text-myfav-primary dark:text-myfav-blue-400" />
                </div>
              ...
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-5 sm:p-6 shadow-lg dark:shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-myfav-primary/10 to-myfav-secondary/10 rounded-xl mb-3 sm:mb-4 mx-auto group-hover:scale-110 transition-transform">
                  <Globe className="h-6 w-6 sm:h-7 sm:w-7 text-myfav-primary dark:text-myfav-blue-400" />
                </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-lg">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-myfav-primary/20 to-myfav-secondary/20 rounded-3xl blur-2xl -z-10" />
                <InteractiveCarousel />
              </div>
            </div>
          </div>
