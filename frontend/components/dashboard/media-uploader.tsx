    ...
    <div>
      <label>
        ...
        <div
          ...
          className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center cursor-pointer hover:border-myfav-primary hover:bg-myfav-primary/5 transition-all disabled:opacity-50"
        >
