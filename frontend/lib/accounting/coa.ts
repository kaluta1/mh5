...
export const COA = {
  ...
  LIABILITIES: {
    ...
    /** Month-to-date accrual; reclassified to PAYABLE_FOUNDING_MEMBERS_ALLOCATED at month-end */
    ACCRUED_FOUNDING_MEMBERS_POOL: '2104',
    PAYABLE_FOUNDING_MEMBERS_ALLOCATED: '2105',
    DEFERRED_REVENUE_ANNUAL: '2110',
    DEFERRED_REVENUE_FOUNDING: '2111',
    DEFERRED_PLATFORM_FEE_CLUB: '2112',
    DEFERRED_REVENUE_VERIFICATION_KYC: '2113',
