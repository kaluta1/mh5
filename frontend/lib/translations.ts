  ...
  en: {
    ...
    dashboard: {
      ...
      contests: {
        ...
        kyc_required_description: "KYC required to participate",
        visual_verification: "Photo of yourself required",
        visual_verification_description: "Visual verification required",
        voice_verification: "Voice verification",
        voice_verification_description: "Voice verification required",
        brand_verification: "Verified brand",
        brand_verification_description: "Verified brand required",
        content_verification: "Original content required",
        content_verification_description: "Original content required",
  ...
  es: {
    ...
    dashboard: {
      ...
      contests: {
        ...
        kyc_required_description: "KYC requerido para participar",
        visual_verification: "Foto tuya requerida",
        visual_verification_description: "Verificación visual requerida",
        voice_verification: "Verificación de voz",
        voice_verification_description: "Verificación de voz requerida",
        brand_verification: "Marca verificada",
        brand_verification_description: "Marca verificada requerida",
        content_verification: "Contenido original requerido",
        content_verification_description: "Contenido original requerido",
  ...
  de: {
    ...
    dashboard: {
      ...
      contests: {
        ...
        kyc_required_description: "KYC erforderlich zur Teilnahme",
        visual_verification: "Foto von Ihnen erforderlich",
        visual_verification_description: "Visuelle Überprüfung erforderlich",
        voice_verification: "Stimmverifizierung",
        voice_verification_description: "Stimmverifizierung erforderlich",
        brand_verification: "Verifizierte Marke",
        brand_verification_description: "Verifizierte Marke erforderlich",
        content_verification: "Originalinhalt erforderlich",
        content_verification_description: "Originalinhalt erforderlich",
