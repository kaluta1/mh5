...
export const analyticsService = {
  ...
  getDefaultAnalytics(): DashboardAnalytics {
    return {
      ...
      weekly_activity: [
        { day: 'Mon', votes: 0, views: 0 },
        { day: 'Tue', votes: 0, views: 0 },
        { day: 'Wed', votes: 0, views: 0 },
        { day: 'Thu', votes: 0, views: 0 },
        { day: 'Fri', votes: 0, views: 0 },
        { day: 'Sat', votes: 0, views: 0 },
        { day: 'Sun', votes: 0, views: 0 },
      ],
      affiliates_stats: {
        direct_count: 0,
        total_network: 0,
      ...
      affiliates_growth: [
        ...
        { month: 'Feb', directs: 0, total: 0, commissions: 0 },
        { month: 'Mar', directs: 0, total: 0, commissions: 0 },
        { month: 'Apr', directs: 0, total: 0, commissions: 0 },
        { month: 'May', directs: 0, total: 0, commissions: 0 },
        { month: 'Jun', directs: 0, total: 0, commissions: 0 },
      ],
      active_contests: 0,
      best_ranking: 0,
      engagement_change: 0,
